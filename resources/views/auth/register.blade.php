                        ...
                        <div>
                            ...
                            <div class="flex -mx-3">
                                <div class="w-full px-3 mb-12">
                                    <label for="password_confirmation" class="text-xs font-semibold px-1">Confirm Your
                                        Password</label>
                                    <div class="flex">
                                        <div
                                            class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                                        ...
                                        <input type="password" name="password_confirmation" id="password_confirmation"
                                            class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500 @error('password_confirmation') border-red-500 @enderror"
                                            placeholder="************">
